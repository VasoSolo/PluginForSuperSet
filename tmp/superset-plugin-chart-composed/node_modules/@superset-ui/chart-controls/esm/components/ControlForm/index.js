...
}__signature__(ControlForm, "useTheme{theme}\nuseMemo{debouncedOnChange}", () => [useTheme]);ControlForm.propTypes = { onChange: _pt.func.isRequired, children: _pt.oneOfType([_pt.element, _pt.arrayOf(_pt.element)]).isRequired };;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(ControlFormRow, "ControlFormRow", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-chart-controls/src/components/ControlForm/index.tsx");reactHotLoader.register(ControlForm, "ControlForm", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-chart-controls/src/components/ControlForm/index.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();