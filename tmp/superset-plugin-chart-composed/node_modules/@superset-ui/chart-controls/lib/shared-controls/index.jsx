...
import { FeatureFlag, t, getCategoricalSchemeRegistry, getSequentialSchemeRegistry, isFeatureEnabled, legacyValidateInteger, validateNonEmpty, ComparisionType, } from '@superset-ui/core';
...
const order_desc = {
    ...
    visibility: ({ controls }) => Boolean(controls?.timeseries_limit_metric.value &&
        controls?.timeseries_limit_metric.value.length),
};
const limit = {
    type: 'SelectControl',
    freeForm: true,
...
const y_axis_format = {
    ...
    mapStateToProps: state => {
        const isPercentage = state.controls?.comparison_type?.value === ComparisionType.Percentage;
        return {
