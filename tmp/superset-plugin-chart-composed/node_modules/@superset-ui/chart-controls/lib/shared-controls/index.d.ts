...
declare type SelectDefaultOption = {
    label: string;
    value: string;
};
declare const sharedControls: {
    ...
    order_desc: import("../types").BaseControlConfig<"CheckboxControl", import("../types").SelectOption, import("@superset-ui/core").JsonValue>;
    ...
    y_axis_format: SelectControlConfig<SelectDefaultOption, "SelectControl">;
    x_axis_time_format: SelectControlConfig<SelectDefaultOption, "SelectControl">;
