...
const NoResultsComponent = ({ className, height, id, width }) => {
  ...
  return (
    ...
    ___EmotionJSX("div", { className: "no-results-title" }, t('No Results')),
    shouldRenderBody &&
    ___EmotionJSX("div", { className: "no-results-body" }, BODY_STRING))));




};NoResultsComponent.propTypes = { className: _pt.string, height: _pt.oneOfType([_pt.number, _pt.string]).isRequired, id: _pt.string, width: _pt.oneOfType([_pt.number, _pt.string]).isRequired };const _default =

NoResultsComponent;export default _default;;(function () {var reactHotLoader = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.default : undefined;if (!reactHotLoader) {return;}reactHotLoader.register(MESSAGE_STYLES, "MESSAGE_STYLES", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-core/src/chart/components/NoResultsComponent.tsx");reactHotLoader.register(MIN_WIDTH_FOR_BODY, "MIN_WIDTH_FOR_BODY", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-core/src/chart/components/NoResultsComponent.tsx");reactHotLoader.register(Container, "Container", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-core/src/chart/components/NoResultsComponent.tsx");reactHotLoader.register(NoResultsComponent, "NoResultsComponent", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-core/src/chart/components/NoResultsComponent.tsx");reactHotLoader.register(_default, "default", "/Users/ville/src/superset-release/superset-frontend/packages/superset-ui-core/src/chart/components/NoResultsComponent.tsx");})();;(function () {var leaveModule = typeof reactHotLoaderGlobal !== 'undefined' ? reactHotLoaderGlobal.leaveModule : undefined;leaveModule && leaveModule(module);})();