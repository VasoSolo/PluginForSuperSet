...
export declare enum ChartLabel {
    DEPRECATED = "DEPRECATED",
    FEATURED = "FEATURED"
}
export declare const chartLabelExplanations: Record<ChartLabel, string>;
export declare const chartLabelWeight: Record<ChartLabel, {
    weight: number;
}>;
