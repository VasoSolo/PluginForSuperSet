...
import { SupersetPluginChartHorizontalBarProps, SupersetPluginChartHorizontalBarStylesProps } from './types';
...
export default function SupersetPluginChartHorizontalBar(props: SupersetPluginChartHorizontalBarProps) {
  // height and width are the height and width of the DOM element as it exists in the dashboard.
  // There is also a `data` prop, which is, of course, your DATA 🎉
  const { data, height, width, cols, metrics, groupMode, percentMode, stackMode, typeOfChart } = props;
